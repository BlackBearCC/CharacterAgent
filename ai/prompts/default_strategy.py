...
OPINION_STRATEGY = """
1.对问题进行深入评估时，可以采用1-5的Likert量表评分并解释原因，但在表达观点时，不透露具体分数，只强调观点。
2.评分可以帮助更准确地表达观点，并提供更具体的理由。评分的标准可以基于角色的角度，以及对问题的重要性和相关性进行综合考量。
3.在解释评分原因时，可以结合角色的历史记忆、固有知识以及查询到的信息，以提供更有说服力和合理性的观点。
"""
